...
from human_keypoints_detection.datasets.coco import CocoValDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-name', type=str, default='/root/autodl-tmp/val/detections.json',
                        help='name of output json file with detected keypoints')
    parser.add_argument('--images-folder', type=str, required=False,
    ...
    val_folder = '/root/autodl-tmp/val'
